...
def pre_pipeline_preparation(*, data_frame: pd.DataFrame) -> pd.DataFrame:
    ...
    data_frame[config.model_config_.date_var] = pd.to_datetime(
        data_frame[config.model_config_.date_var],
        format=config.model_config_.date_var_format
    )

    # Add new year and month features
    data_frame[config.model_config_.year_var] = data_frame[config.model_config_.date_var].dt.year
    data_frame[config.model_config_.month_var] = data_frame[config.model_config_.date_var].dt.month_name()

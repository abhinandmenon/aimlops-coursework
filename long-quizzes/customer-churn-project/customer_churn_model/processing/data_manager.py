...
from customer_churn_model.config.core import DATASET_DIR, TRAINED_MODEL_DIR, config


##  Pre-Pipeline Preparation  
def pre_pipeline_preparation(*, data_frame: pd.DataFrame) -> pd.DataFrame:
    # Preprocessing of the dataset to remove the one empty line in csv file
